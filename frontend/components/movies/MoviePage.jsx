        ...
        <div className="flex w-full">
          ...
          <div className="w-[60%] flex flex-col mt-24 gap-3 ml-10">
            ...
            <p className="text-slate-400">
              <span className="font-semibold">23,190</span> people have invested
              in this film.
            </p>
            <div className="flex gap-2">
              <div className="bg-yellow-500 p-2 flex items-center justify-center text-main rounded-full">
                <p>Blockbuster</p>
              </div>
              <div className="bg-slate-500 p-2 flex items-center justify-center text-main rounded-full">
        ...
        <div className="flex w-full mt-20 gap-10">
          ...
          <div className="w-[60%] bg-secondary rounded-lg border border-slate-800 flex flex-col h-[100%] px-5 py-5">
            <p className="font-semibold">
              Overall Gain: ₹ 11,000{" "}
              <FaArrowTrendUp className="text-green-500 inline-block mb-1" />
            </p>
            <p className="text-xs">
